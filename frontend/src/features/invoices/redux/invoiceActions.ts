...
export const FETCH_LAST_INVOICE_NUMBER_REQUEST =
  "invoices/FETCH_LAST_INVOICE_NUMBER_REQUEST";
export const FETCH_LAST_INVOICE_NUMBER_SUCCESS =
  "invoices/FETCH_LAST_INVOICE_NUMBER_SUCCESS";
export const FETCH_LAST_INVOICE_NUMBER_FAILURE =
  "invoices/FETCH_LAST_INVOICE_NUMBER_FAILURE";

export const CLEAR_INVOICE = "invoices/CLEAR_INVOICE";
export const CLEAR_ERRORS = "invoices/CLEAR_ERRORS";
export const CLEAR_ACTION_STATUS = "invoices/CLEAR_ACTION_STATUS"; // Nowa akcja

export const UPDATE_INVOICE_PAYMENT_REQUEST =
  "invoices/UPDATE_INVOICE_PAYMENT_REQUEST";
export const UPDATE_INVOICE_PAYMENT_SUCCESS =
  "invoices/UPDATE_INVOICE_PAYMENT_SUCCESS";
export const UPDATE_INVOICE_PAYMENT_FAILURE =
  "invoices/UPDATE_INVOICE_PAYMENT_FAILURE";
...
// Nowa akcja clearActionStatus
export const clearActionStatus = () => ({
  type: CLEAR_ACTION_STATUS,
});

export const updateInvoicePaymentRequest = (
  id: number,
  paidAmount: number
) => ({
